...
void HAL_TIM_MspPostInit(TIM_HandleTypeDef* htim)
{
  ...
  if(htim->Instance==TIM1)
  {
    ...
    PA10     ------> TIM1_CH3
    */
    GPIO_InitStruct.Pin = nLS1_Pin|nLS2_Pin|nLS3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    ...
    GPIO_InitStruct.Pin = nHS1_Pin|nHS2_Pin|nHS3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_PULLUP;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF2_TIM1;
...
void HAL_TIM_Base_MspDeInit(TIM_HandleTypeDef* htim_base)
{
  if(htim_base->Instance==TIM1)
  {
    ...
    PA10     ------> TIM1_CH3
    */
    HAL_GPIO_DeInit(GPIOB, nFault_Pin|nLS1_Pin|nLS2_Pin|nLS3_Pin);

    HAL_GPIO_DeInit(GPIOA, nHS1_Pin|nHS2_Pin|nHS3_Pin);
...
void HAL_TIMEx_HallSensor_MspDeInit(TIM_HandleTypeDef* htimex_hallsensor)
{
  if(htimex_hallsensor->Instance==TIM2)
  {
    ...
    PA2     ------> TIM2_CH3
    */
    HAL_GPIO_DeInit(GPIOA, Hall1_Pin|Hall2_Pin|Hall3_Pin);
